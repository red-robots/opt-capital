<?php
$themeURI = get_stylesheet_directory_uri() . '/inc/taxonomy-order';
$dir_path = get_theme_file_path() . '/inc/taxonomy-order';
define('TOPATH', $dir_path);
define('TOURL', $themeURI);
...
//add_options_page('Taxonomy Order Setting', '' . __('Taxonomy Order Setting', 'taxonomy-terms-order'), 'manage_options', 'to-options', 'to_plugin_options');
